...
class GaitPolicyWrapper(gym.Wrapper):
    ...
    def step(self, gaits):
        ...
        rew_smooth, (dgaits_norm, learnable_names) = self._reward_gait_smooth()
        ...
        for i, name in enumerate(learnable_names):
    ...
    def _sample_velocity_commands(self, env_ids):
        ...
        # For evaluation
        self.current_vel_cmds[env_ids, :] = torch.tensor([[1.2, 0.0, 0.0]], device=self.device)
