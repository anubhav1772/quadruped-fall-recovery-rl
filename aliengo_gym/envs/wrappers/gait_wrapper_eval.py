...
class GaitPolicyWrapper(gym.Wrapper):
    ...
    def __init__(self, env, policy2, cfg):
        ...
        # FOR  EVALUATION ONLY
        self.pi1_dir = "/home/anubhav1772/Documents/TEST/WTW-Aliengo/runs/gait-conditioned-agility/2026-01-29/train_gait_generator/222020.849949"
    ...
    def step(self, gaits):
        ...
        info_hl["privileged_obs"] = obs["privileged_obs"]
