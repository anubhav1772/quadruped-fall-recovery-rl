...
class BaseCfg(PrefixProto, cli=False):
    ...
    class asset(PrefixProto, cli=False):
        ...
        fix_base_link = False  # fixed the base of the robot
    ...
    class env(PrefixProto, cli=False):
        ...
        num_privileged_obs = 6 # friction, restitution, (possibly heightmap)
        ...
        episode_length_s = 3 #20  # episode length in seconds
        observe_vel = False
    ...
    class rewards(PrefixProto, cli=False):
        ...
        use_terminal_body_height = False # not for learning recovery
